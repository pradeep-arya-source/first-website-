...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="title-page" style="color: #fff;">Option Trading</div>
            <div class="breadcrumb-container">
                <ol class="breadcrumb">
                    <li><a href="index.php" style="color: #fff;">Home</a></li>
                    <li class="active" style="color: #fff;">Option Trading</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6">
            <img src="./images/option-trading-1.webp" alt="">
            <div class="margin-bottom-30"></div>
        </div>
        <div class="col-sm-6 col-md-6">
            <h3>Option Trading Courses</h3>
            <div class="margin-bottom-30"></div>
    ...
    <div class="col-sm-4 col-md-4">
                    <div class="box-icon-1">
                        ...
                        <div class="body-content">
                            ...
                            <a href="services-detail.html" class="readmore">read more <i
