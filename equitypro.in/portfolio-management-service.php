...
<div id="slides" class="section banner">
    <ul class="slides-container">
        <li>
            <img src="images/pms.jpg" alt="">
            <div class="overlay-bg"></div>
            <div class="container">
                <div class="wrap-caption center">
                    <h2 class="caption-heading">
                        <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Est, temporibus.</span>
                    </h2>
					...
					<div class="single-page">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12">
								...
								<p>Lorem ipsum dolor Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae quidem voluptate porro! Harum magni cupiditate distinctio nostrum. Ducimus, quasi voluptatum? sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco.</p> 
								<ul class="bull">
						...
						<div class="margin-bottom-50"></div>
						<h2 class="section-heading left">
							somthing Lorem ipsum dolor sit amet.
						</h2>
						<div class="section-subheading">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </div> 
		...
		<div class="container">
			<div class="row">
					...
					<div class="widget contact-info-sidebar">
						...
						<ul class="list-info">
							...
							<li>
								...
								<div class="info-text">info@finanzi.com</div>
							</li>
							<li>
								<div class="info-icon">
				...
				<div class="col-sm-9 col-md-9">
					<div class="single-page">
						<img src="images/advisory-2.webp" alt="" class="img-responsive"> 
					...
					<div id="owl-testimony">
						<div class="item">
							<div class="testimonial-1">
					            <div class="media">
					              <img src="images/testimonial.webp" alt="" class="img-circle">
					            </div>
					            <div class="body">
